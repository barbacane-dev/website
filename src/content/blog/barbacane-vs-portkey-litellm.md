...
And one more capability Portkey and LiteLLM do not offer: Barbacane is also an [MCP gateway](/ai/). The same artifact that proxies your LLM traffic outbound also exposes your existing APIs to AI agents as tools inbound. One gateway covers both directions of AI traffic.
